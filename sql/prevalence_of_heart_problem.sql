...
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('country','KE','prevalence_of_heart_problem','allPrevalenceOfHeartProblems','"Kenya Integrated Household Budget Survey, 2016"','https://open.africa/dataset/kenya-integrated-household-budget-survey-2016/resource/44da62a0-cf7b-40c7-ba07-05035b794fb3') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('level1','KE','prevalence_of_heart_problem','allPrevalenceOfHeartProblems','"Kenya Integrated Household Budget Survey, 2016"','https://open.africa/dataset/kenya-integrated-household-budget-survey-2016/resource/44da62a0-cf7b-40c7-ba07-05035b794fb3') on conflict do nothing;
