...
ALTER TABLE IF EXISTS ONLY public.py_trade_industry_tourism_cooperatives_dept DROP CONSTRAINT IF EXISTS pk_py_trade_industry_tourism_cooperatives_dept;
DROP TABLE IF EXISTS public.py_trade_industry_tourism_cooperatives_dept;
SET default_tablespace = '';

SET default_with_oids = false;

CREATE TABLE IF NOT EXISTS public.py_trade_industry_tourism_cooperatives_dept (
	geo_level TEXT,
	geo_code TEXT,
	geo_version NUMERIC,
	parent_level TEXT,
