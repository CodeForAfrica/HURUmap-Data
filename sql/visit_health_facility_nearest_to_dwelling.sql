...
('level1','ZA_1_002',2009,'country','ZA','No',264037.84,'Eastern Cape'),
('level1','ZA_1_002',2009,'country','ZA','Yes',6244099.69,'Eastern Cape'),
('level1','ZA_1_004',2009,'country','ZA','No',216033.48,'Free State'),
('level1','ZA_1_004',2009,'country','ZA','Yes',2675214.6,'Free State'),
('level1','ZA_1_007',2009,'country','ZA','Yes',13533853.73,'Gauteng'),
('level1','ZA_1_007',2009,'country','ZA','No',1126890.77,'Gauteng'),
('level1','ZA_1_005',2009,'country','ZA','No',355578.11,'KwaZulu-Natal'),
('level1','ZA_1_005',2009,'country','ZA','Yes',10859639.48,'KwaZulu-Natal'),
('level1','ZA_1_009',2009,'country','ZA','No',230456.55,'Limpopo'),
('level1','ZA_1_009',2009,'country','ZA','Yes',5623299.54,'Limpopo'),
('level1','ZA_1_008',2009,'country','ZA','No',191967.01,'Mpumalanga'),
('level1','ZA_1_008',2009,'country','ZA','Yes',4331466.47,'Mpumalanga'),
('level1','ZA_1_006',2009,'country','ZA','No',424599.86,'North West'),
('level1','ZA_1_006',2009,'country','ZA','Yes',3500618.47,'North West'),
('level1','ZA_1_003',2009,'country','ZA','Yes',1133960.57,'Northern Cape'),
('level1','ZA_1_003',2009,'country','ZA','No',95833.83,'Northern Cape'),
('country','ZA',2009,'continent','AFR','No',3756597.71,'South Africa'),
('country','ZA',2009,'continent','AFR','Yes',53701213.3,'South Africa'),
('level1','ZA_1_001',2009,'country','ZA','No',851200.25,'Western Cape'),
('level1','ZA_1_001',2009,'country','ZA','Yes',5799060.76,'Western Cape') ON CONFLICT DO NOTHING;
