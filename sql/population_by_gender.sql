...
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('level1','KE','population_by_gender','allPopulationByGenders','"Kenya Population and Housing Census, 2019"','https://open.africa/dataset/2019-kenya-population-and-housing-census/resource/d0c95fee-9d00-453a-b343-7c195e81b9f1') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('country','KE','population_by_gender','allPopulationByGenders','"Kenya Population and Housing Census, 2019"','https://open.africa/dataset/2019-kenya-population-and-housing-census/resource/d0c95fee-9d00-453a-b343-7c195e81b9f1') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('level1','ZA','population_by_gender','allPopulationByGenders','"Community Survey, 2016"','https://open.africa/dataset/community-survey-south-africa-2016/resource/ae3e7faf-d9c2-4996-880a-adaf9017d087') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('country','ZA','population_by_gender','allPopulationByGenders','"Community Survey, 2016"','https://open.africa/dataset/community-survey-south-africa-2016/resource/ae3e7faf-d9c2-4996-880a-adaf9017d087') on conflict do nothing;
