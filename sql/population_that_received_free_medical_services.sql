...
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('level1','KE','population_that_received_free_medical_services','allPopulationThatReceivedFreeMedicalServices','"Kenya Integrated Household Budget Survey, 2016"','https://open.africa/dataset/kenya-integrated-household-budget-survey-2016/resource/4492472d-62b3-4721-8bb9-dd51bb5e960d') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('country','KE','population_that_received_free_medical_services','allPopulationThatReceivedFreeMedicalServices','"Kenya Integrated Household Budget Survey, 2016"','https://open.africa/dataset/kenya-integrated-household-budget-survey-2016/resource/4492472d-62b3-4721-8bb9-dd51bb5e960d') on conflict do nothing;
