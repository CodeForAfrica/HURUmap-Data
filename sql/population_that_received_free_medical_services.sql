...
('level1','KE_1_006',2009,'country','KE','Tuberculosis Treatment',0,'Taita Taveta'),
('level1','KE_1_006',2009,'country','KE','Nutrition Feeding',0,'Taita Taveta'),
('level1','KE_1_006',2009,'country','KE','Malaria',14.5,'Taita Taveta'),
('level1','KE_1_006',2009,'country','KE','HIV/AIDS',0.8,'Taita Taveta'),
('level1','KE_1_006',2009,'country','KE','Not Stated',0,'Taita Taveta'),
('level1','KE_1_006',2009,'country','KE','Maternal & Child Health Care (MCH)',33.4,'Taita Taveta'),
('level1','KE_1_006',2009,'country','KE','Other',51.2,'Taita Taveta'),
...
('level1','KE_1_024',2009,'country','KE','Tuberculosis Treatment',0,'West Pokot') ON CONFLICT DO NOTHING;
