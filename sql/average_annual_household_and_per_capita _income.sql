...
ALTER TABLE IF EXISTS ONLY public.average_annual_household_and_per_capita _income DROP CONSTRAINT IF EXISTS pk_average_annual_household_and_per_capita _income;
DROP TABLE IF EXISTS public.average_annual_household_and_per_capita _income;
SET default_tablespace = '';

SET default_with_oids = false;

CREATE TABLE IF NOT EXISTS public.average_annual_household_and_per_capita _income (
	geo_level TEXT,
	geo_code TEXT,
	geo_version NUMERIC,
	parent_level TEXT,
...
ALTER TABLE ONLY public.average_annual_household_and_per_capita _income ADD CONSTRAINT pk_average_annual_household_and_per_capita _income PRIMARY KEY (geo_level, geo_code, geo_version, parent_level, parent_code, variable, value, name);

INSERT INTO public.average_annual_household_and_per_capita _income VALUES
