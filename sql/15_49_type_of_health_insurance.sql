...
ALTER TABLE IF EXISTS ONLY public.15_49_type_of_health_insurance DROP CONSTRAINT IF EXISTS pk_15_49_type_of_health_insurance;
DROP TABLE IF EXISTS public.15_49_type_of_health_insurance;
SET default_tablespace = '';

SET default_with_oids = false;

CREATE TABLE IF NOT EXISTS public.15_49_type_of_health_insurance (
	geo_level TEXT,
	geo_code TEXT,
	geo_version NUMERIC,
	parent_level TEXT,
...
INSERT INTO public.15_49_type_of_health_insurance VALUES
...
INSERT into public.sources(geo_level, country_code, table_name, source_title, source_link) VALUES('country','GH','all1549TypeOfHealthInsurances','"Ghana Multiple Indicator Cluster Survey, 2017/18"','https://open.africa/dataset/ghana-multiple-indicator-cluster-survey/resource/5343369d-68d3-42ba-94b9-36a4c688a663') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, table_name, source_title, source_link) VALUES('level1','GH','all1549TypeOfHealthInsurances','"Ghana Multiple Indicator Cluster Survey, 2017/18"','https://open.africa/dataset/ghana-multiple-indicator-cluster-survey/resource/5343369d-68d3-42ba-94b9-36a4c688a663') on conflict do nothing;

ALTER TABLE ONLY public.15_49_type_of_health_insurance ADD CONSTRAINT pk_15_49_type_of_health_insurance PRIMARY KEY (geo_level, geo_code, geo_version, parent_level, parent_code, variable_2, variable_1, value, name);
