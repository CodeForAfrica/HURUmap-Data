...
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','IDA (WB) Credit: Kenya Urban Support Project (KUSP) -Urban Development Grant (UDG)',773.57,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','IDA (WB) Credit: Kenya Urban Support Project (KUSP) -Urban Development Grant (UDG)',773.57,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','IDA (WB) Credit: Kenya Urban Support Project (KUSP) -Urban Development Grant (UDG)',0,'Kisumu'),
...
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','IDA (WB) Kenya Climate Smart Agriculture Project (KCSAP)',118.48,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','IDA (WB) Kenya Climate Smart Agriculture Project (KCSAP)',118.48,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','IDA (WB) Kenya Climate Smart Agriculture Project (KCSAP)',45.39,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','EU Grant (Instruments for Devolution Advise and Support IDEAS)',36.07,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','EU Grant (Instruments for Devolution Advise and Support IDEAS)',90,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','EU Grant (Instruments for Devolution Advise and Support IDEAS)',0,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','EU - Water Tower Protection and Climate Change Mitigation and Adaptation Programme (WaTER )',80,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','EU - Water Tower Protection and Climate Change Mitigation and Adaptation Programme (WaTER )',80,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','EU - Water Tower Protection and Climate Change Mitigation and Adaptation Programme (WaTER )',0,'Kisumu'),
...
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','IDA (WB) Credit: Kenya Devolution Support Project (KDSP) Level 1 Grant',30,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','IDA (WB) Credit: Kenya Devolution Support Project (KDSP) Level 1 Grant',49.64,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','IDA (WB) Credit: Kenya Devolution Support Project (KDSP) Level 1 Grant',0,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','IDA (WB) Credit: Kenya Urban Support Project (KUSP) -Urban Institutional Grants (UIG)',8.8,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','IDA (WB) Credit: Kenya Urban Support Project (KUSP) -Urban Institutional Grants (UIG)',41.2,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','IDA (WB) Credit: Kenya Urban Support Project (KUSP) -Urban Institutional Grants (UIG)',0,'Kisumu'),
...
('level1','KE_1_042',2009,'country','KE','Annual CARA Allocation','Sweden - Agricultural Sector Development Support Programme (ASDSP) II',17.03,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Annual Budget Allocation','Sweden - Agricultural Sector Development Support Programme (ASDSP) II',16.33,'Kisumu'),
('level1','KE_1_042',2009,'country','KE','Actual Receipts','Sweden - Agricultural Sector Development Support Programme (ASDSP) II',0,'Kisumu') ON CONFLICT DO NOTHING;
