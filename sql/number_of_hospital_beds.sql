...
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('level1','KE','number_of_hospital_beds','allNumberOfHospitalBeds','"Kenya Master Health Facility List, 2020"','https://open.africa/dataset/kenya-master-health-facility-list-2020/resource/38b72113-8cd5-40b2-960d-1baefd32c8f1') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('country','KE','number_of_hospital_beds','allNumberOfHospitalBeds','"Kenya Master Health Facility List, 2020"','https://open.africa/dataset/kenya-master-health-facility-list-2020/resource/38b72113-8cd5-40b2-960d-1baefd32c8f1') on conflict do nothing;
