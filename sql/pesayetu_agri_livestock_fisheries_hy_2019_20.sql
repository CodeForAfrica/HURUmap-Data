...
ALTER TABLE IF EXISTS ONLY public.pesayetu_agri_livestock_fisheries_hy_2019_20 DROP CONSTRAINT IF EXISTS pk_pesayetu_agri_livestock_fisheries_hy_2019_20;
DROP TABLE IF EXISTS public.pesayetu_agri_livestock_fisheries_hy_2019_20;
SET default_tablespace = '';

SET default_with_oids = false;

CREATE TABLE IF NOT EXISTS public.pesayetu_agri_livestock_fisheries_hy_2019_20 (
	geo_level TEXT,
	geo_code TEXT,
	geo_version NUMERIC,
	parent_level TEXT,
