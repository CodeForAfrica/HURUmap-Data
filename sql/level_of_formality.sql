...
('level1','KE_1_030',2009,'country','KE','Total','Rural',591474,'Baringo'),
...
('level1','KE_1_030',2009,'country','KE','Total','Urban',75289,'Baringo'),
...
('level1','KE_1_036',2009,'country','KE','Total','Rural',847718,'Bomet'),
...
('level1','KE_1_036',2009,'country','KE','Total','Urban',27971,'Bomet'),
...
('level1','KE_1_039',2009,'country','KE','Total','Rural',1480458,'Bungoma'),
...
('level1','KE_1_040',2009,'country','KE','Total','Urban',113753,'Busia'),
('level1','KE_1_040',2009,'country','KE','Male','Urban',54963,'Busia'),
('level1','KE_1_040',2009,'country','KE','Intersex','Urban',0,'Busia'),
('level1','KE_1_014',2009,'country','KE','Total','Rural',532675,'Embu'),
...
('level1','KE_1_014',2009,'country','KE','Total','Urban',75924,'Embu'),
...
('level1','KE_1_007',2009,'country','KE','Total','Rural',630463,'Garissa'),
...
('level1','KE_1_007',2009,'country','KE','Total','Urban',210890,'Garissa'),
('level1','KE_1_043',2009,'country','KE','Total','Rural',1018871,'Homa Bay'),
...
('level1','KE_1_043',2009,'country','KE','Total','Urban',113079,'Homa Bay'),
...
('level1','KE_1_011',2009,'country','KE','Total','Rural',142333,'Isiolo'),
...
('level1','KE_1_011',2009,'country','KE','Total','Urban',125669,'Isiolo'),
('level1','KE_1_034',2009,'country','KE','Male','Rural',250233,'Kajiado'),
('level1','KE_1_034',2009,'country','KE','Total','Rural',495218,'Kajiado'),
...
('level1','KE_1_034',2009,'country','KE','Total','Urban',622622,'Kajiado'),
...
('level1','KE_1_037',2009,'country','KE','Total','Rural',1682239,'Kakamega'),
...
('level1','KE_1_037',2009,'country','KE','Total','Urban',185340,'Kakamega'),
...
('country','KE',2009,'continent','AFR','Total','Rural',32732596,'Kenya'),
...
('country','KE',2009,'continent','AFR','Total','Urban',14831700,'Kenya'),
...
('level1','KE_1_035',2009,'country','KE','Total','Rural',808239,'Kericho'),
...
('level1','KE_1_035',2009,'country','KE','Total','Urban',93538,'Kericho'),
('level1','KE_1_022',2009,'country','KE','Female','Rural',355866,'Kiambu'),
('level1','KE_1_022',2009,'country','KE','Male','Rural',355557,'Kiambu'),
('level1','KE_1_022',2009,'country','KE','Total','Rural',711450,'Kiambu'),
...
('level1','KE_1_022',2009,'country','KE','Total','Urban',1706285,'Kiambu'),
...
('level1','KE_1_003',2009,'country','KE','Total','Rural',1059899,'Kilifi'),
...
('level1','KE_1_003',2009,'country','KE','Total','Urban',393888,'Kilifi'),
('level1','KE_1_003',2009,'country','KE','Intersex','Urban',6,'Kilifi'),
('level1','KE_1_020',2009,'country','KE','Total','Rural',474187,'Kirinyaga'),
...
('level1','KE_1_020',2009,'country','KE','Total','Urban',136224,'Kirinyaga'),
...
('level1','KE_1_045',2009,'country','KE','Total','Rural',1115450,'Kisii'),
...
('level1','KE_1_045',2009,'country','KE','Total','Urban',151410,'Kisii'),
...
('level1','KE_1_042',2009,'country','KE','Total','Rural',714668,'Kisumu'),
...
('level1','KE_1_042',2009,'country','KE','Total','Urban',440906,'Kisumu'),
...
('level1','KE_1_015',2009,'country','KE','Total','Rural',1082168,'Kitui'),
...
('level1','KE_1_015',2009,'country','KE','Total','Urban',54019,'Kitui'),
...
('level1','KE_1_002',2009,'country','KE','Total','Rural',740389,'Kwale'),
...
('level1','KE_1_002',2009,'country','KE','Total','Urban',126431,'Kwale'),
('level1','KE_1_031',2009,'country','KE','Total','Rural',391200,'Laikipia'),
...
('level1','KE_1_031',2009,'country','KE','Total','Urban',127360,'Laikipia'),
...
('level1','KE_1_005',2009,'country','KE','Total','Rural',105474,'Lamu'),
...
('level1','KE_1_005',2009,'country','KE','Total','Urban',38446,'Lamu'),
...
('level1','KE_1_016',2009,'country','KE','Total','Rural',1007854,'Machakos'),
...
('level1','KE_1_016',2009,'country','KE','Total','Urban',414078,'Machakos'),
...
('level1','KE_1_017',2009,'country','KE','Total','Rural',910577,'Makueni'),
...
('level1','KE_1_017',2009,'country','KE','Total','Urban',77076,'Makueni'),
('level1','KE_1_017',2009,'country','KE','Male','Urban',39209,'Makueni'),
('level1','KE_1_009',2009,'country','KE','Male','Rural',299428,'Mandera'),
('level1','KE_1_009',2009,'country','KE','Total','Rural',596990,'Mandera'),
...
('level1','KE_1_009',2009,'country','KE','Total','Urban',270467,'Mandera'),
...
('level1','KE_1_010',2009,'country','KE','Total','Rural',352546,'Marsabit'),
...
('level1','KE_1_010',2009,'country','KE','Total','Urban',107239,'Marsabit'),
...
('level1','KE_1_012',2009,'country','KE','Total','Rural',1406796,'Meru'),
...
('level1','KE_1_012',2009,'country','KE','Total','Urban',138918,'Meru'),
...
('level1','KE_1_044',2009,'country','KE','Total','Rural',949236,'Migori'),
...
('level1','KE_1_044',2009,'country','KE','Total','Urban',167200,'Migori'),
...
('level1','KE_1_001',2009,'country','KE','Total','Rural',0,'Mombasa'),
...
('level1','KE_1_001',2009,'country','KE','Total','Urban',1208333,'Mombasa'),
...
('level1','KE_1_021',2009,'country','KE','Total','Rural',938213,'Murang''a'),
...
('level1','KE_1_021',2009,'country','KE','Total','Urban',118427,'Murang''a'),
('level1','KE_1_032',2009,'country','KE','Female','Rural',555458,'Nakuru'),
('level1','KE_1_032',2009,'country','KE','Male','Rural',559639,'Nakuru'),
('level1','KE_1_032',2009,'country','KE','Total','Rural',1115122,'Nakuru'),
...
('level1','KE_1_032',2009,'country','KE','Total','Urban',1047080,'Nakuru'),
...
('level1','KE_1_029',2009,'country','KE','Total','Rural',826232,'Nandi'),
...
('level1','KE_1_029',2009,'country','KE','Total','Urban',59479,'Nandi'),
('level1','KE_1_029',2009,'country','KE','Male','Urban',29544,'Nandi'),
('level1','KE_1_033',2009,'country','KE','Total','Rural',1057521,'Narok'),
...
('level1','KE_1_033',2009,'country','KE','Total','Urban',100352,'Narok'),
...
('level1','KE_1_046',2009,'country','KE','Total','Rural',558540,'Nyamira'),
...
('level1','KE_1_046',2009,'country','KE','Total','Urban',47036,'Nyamira'),
...
('level1','KE_1_018',2009,'country','KE','Total','Rural',571754,'Nyandarua'),
...
('level1','KE_1_018',2009,'country','KE','Total','Urban',66535,'Nyandarua'),
('level1','KE_1_019',2009,'country','KE','Total','Rural',608409,'Nyeri'),
...
('level1','KE_1_019',2009,'country','KE','Total','Urban',150755,'Nyeri'),
...
('level1','KE_1_025',2009,'country','KE','Total','Rural',263195,'Samburu'),
...
('level1','KE_1_025',2009,'country','KE','Total','Urban',47132,'Samburu'),
('level1','KE_1_025',2009,'country','KE','Intersex','Urban',0,'Samburu'),
('level1','KE_1_025',2009,'country','KE','Male','Urban',23716,'Samburu'),
('level1','KE_1_041',2009,'country','KE','Total','Rural',907766,'Siaya'),
...
('level1','KE_1_041',2009,'country','KE','Total','Urban',85417,'Siaya'),
...
('level1','KE_1_004',2009,'country','KE','Total','Rural',240221,'Tana River'),
...
('level1','KE_1_004',2009,'country','KE','Total','Urban',75722,'Tana River'),
...
('level1','KE_1_013',2009,'country','KE','Total','Rural',360434,'Tharaka-Nithi'),
...
('level1','KE_1_013',2009,'country','KE','Total','Urban',32743,'Tharaka-Nithi'),
('level1','KE_1_023',2009,'country','KE','Total','Rural',786185,'Turkana'),
...
('level1','KE_1_023',2009,'country','KE','Total','Urban',140791,'Turkana'),
...
('level1','KE_1_027',2009,'country','KE','Total','Rural',652981,'Uasin Gishu'),
...
('level1','KE_1_027',2009,'country','KE','Total','Urban',510205,'Uasin Gishu'),
...
('level1','KE_1_038',2009,'country','KE','Total','Rural',531629,'Vihiga'),
...
('level1','KE_1_038',2009,'country','KE','Total','Urban',58384,'Vihiga'),
('level1','KE_1_008',2009,'country','KE','Female','Rural',283500,'Wajir'),
('level1','KE_1_008',2009,'country','KE','Intersex','Rural',27,'Wajir'),
('level1','KE_1_008',2009,'country','KE','Total','Rural',604089,'Wajir'),
...
('level1','KE_1_008',2009,'country','KE','Total','Urban',177174,'Wajir'),
('level1','KE_1_008',2009,'country','KE','Male','Urban',94812,'Wajir'),
('level1','KE_1_024',2009,'country','KE','Total','Rural',589400,'West Pokot'),
...
('level1','KE_1_024',2009,'country','KE','Total','Urban',31841,'West Pokot'),
...
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('level1','KE','level_of_formality','allLevelOfFormalities','"Kenya Population and Housing Census, 2019"','https://open.africa/dataset/2019-kenya-population-and-housing-census') on conflict do nothing;
INSERT into public.sources(geo_level, country_code, pg_table_name, table_name, source_title, source_link) VALUES('country','KE','level_of_formality','allLevelOfFormalities','"Kenya Population and Housing Census, 2019"','https://open.africa/dataset/2019-kenya-population-and-housing-census') on conflict do nothing;
